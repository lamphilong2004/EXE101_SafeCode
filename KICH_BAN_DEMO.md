...
- Bấm nút **Upload Code**, điền tên dự án, đặt giá tiền (ví dụ 100.000 VNĐ) và tải file ZIP lên.
- *Nhấn mạnh:* "Source code sau khi upload sẽ ngay lập tức được mã hóa và bảo vệ an toàn trên server."
...
- *Sau khi chuyển khoản xong, chỉ tay vào màn hình:* "Ban giám khảo có thể thấy, không cần bấm F5, Webhook ngân hàng đã tự động xác nhận, Website tự động đóng Form mã QR, hiện thông báo giao dịch thành công và mã nguồn đã lập tức được mở khóa để khách tải về."
...
1. **Tạo Data mẫu:** Tạo sẵn 1 acc Admin, 1 acc Freelancer, 1 acc Client. Upload sẵn vài file có tên đàng hoàng (như "Đồ án ReactJS", "Website bán hàng PHP") để giao diện nhìn xịn.
